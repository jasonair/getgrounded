 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zr="FirebaseError";class gt extends Error{constructor(e,s,o){super(s),this.code=e,this.customData=o,this.name=zr,Object.setPrototypeOf(this,gt.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,be.prototype.create)}}class be{constructor(e,s,o){this.service=e,this.serviceName=s,this.errors=o}create(e,...s){const o=s[0]||{},h=`${this.service}/${e}`,u=this.errors[e],g=u?Gr(u,o):"Error",w=`${this.serviceName}: ${g} (${h}).`;return new gt(h,w,o)}}function Gr(n,e){return n.replace(qr,(s,o)=>{const h=e[o];return h!=null?String(h):`<${o}?>`})}const qr=/\{\$([^}]+)}/g;function Zt(n,e){if(n===e)return!0;const s=Object.keys(n),o=Object.keys(e);for(const h of s){if(!o.includes(h))return!1;const u=n[h],g=e[h];if(Ci(u)&&Ci(g)){if(!Zt(u,g))return!1}else if(u!==g)return!1}for(const h of o)if(!s.includes(h))return!1;return!0}function Ci(n){return n!==null&&typeof n=="object"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ot=new vn("@firebase/app"),vo="@firebase/app-compat",wo="@firebase/analytics-compat",Eo="@firebase/analytics",Io="@firebase/app-check-compat",To="@firebase/app-check",Ao="@firebase/auth",_o="@firebase/auth-compat",bo="@firebase/database",So="@firebase/data-connect",Co="@firebase/database-compat",Do="@firebase/functions",ko="@firebase/functions-compat",Ro="@firebase/installations",Po="@firebase/installations-compat",Oo="@firebase/messaging",Lo="@firebase/messaging-compat",No="@firebase/performance",Mo="@firebase/performance-compat",jo="@firebase/remote-config",Bo="@firebase/remote-config-compat",Fo="@firebase/storage",xo="@firebase/storage-compat",$o="@firebase/firestore",Uo="@firebase/vertexai",Ho="@firebase/firestore-compat",Vo="firebase",zo="11.6.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Jo=zo;function ds(n,e={}){let s=n;typeof e!="object"&&(e={name:e});const o=Object.assign({name:fn,automaticDataCollectionEnabled:!1},e),h=o.name;if(typeof h!="string"||!h)throw dt.create("bad-app-name",{appName:String(h)});if(s||(s=os()),!s)throw dt.create("no-options");const u=Ie.get(h);if(u){if(Zt(s,u.options)&&Zt(o,u.config))return u;throw dt.create("duplicate-app",{appName:h})}const g=new to(h);for(const I of dn.values())g.addComponent(I);const w=new Xo(s,o,g);return Ie.set(h,w),w}function ps(n=fn){const e=Ie.get(n);if(!e&&n===fn&&os())return ds();if(!e)throw dt.create("no-app",{appName:n});return e}function et(n,e,s){var o;let h=(o=Go[n])!==null&&o!==void 0?o:n;s&&(h+=`-${s}`);const u=h.match(/\s|\//),g=e.match(/\s|\//);if(u||g){const w=[`Unable to register library "${h}" with version "${e}":`];u&&w.push(`library name "${h}" contains illegal characters (whitespace or "/")`),u&&g&&w.push("and"),g&&w.push(`version name "${e}" contains illegal characters (whitespace or "/")`),ot.warn(w.join(" "));return}pt(new rt(`${h}-version`,()=>({library:h,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ta=1024,ea=30;class na{constructor(e){this.container=e,this._heartbeatsCache=null;const s=this.container.getProvider("app").getImmediate();this._storage=new sa(s),this._heartbeatsCachePromise=this._storage.read().then(o=>(this._heartbeatsCache=o,o))}async triggerHeartbeat(){var e,s;try{const h=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),u=Mi();if(((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((s=this._heartbeatsCache)===null||s===void 0?void 0:s.heartbeats)==null)||this._heartbeatsCache.lastSentHeartbeatDate===u||this._heartbeatsCache.heartbeats.some(g=>g.date===u))return;if(this._heartbeatsCache.heartbeats.push({date:u,agent:h}),this._heartbeatsCache.heartbeats.length>ea){const g=ra(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(g,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(o){ot.warn(o)}}async getHeartbeatsHeader(){var e;try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const s=Mi(),{heartbeatsToSend:o,unsentEntries:h}=ia(this._heartbeatsCache.heartbeats),u=Ee(JSON.stringify({version:2,heartbeats:o}));return this._heartbeatsCache.lastSentHeartbeatDate=s,h.length>0?(this._heartbeatsCache.heartbeats=h,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),u}catch(s){return ot.warn(s),""}}}function Mi(){return new Date().toISOString().substring(0,10)}function ia(n,e=ta){const s=[];let o=n.slice();for(const h of n){const u=s.find(g=>g.agent===h.agent);if(u){if(u.dates.push(h.date),ji(s)>e){u.dates.pop();break}}else if(s.push({agent:h.agent,dates:[h.date]}),ji(s)>e){s.pop();break}o=o.slice(1)}return{heartbeatsToSend:s,unsentEntries:o}}class sa{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return as()?hs().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const s=await Qo(this.app);return s!=null&&s.heartbeats?s:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){var s;if(await this._canUseIndexedDBPromise){const h=await this.read();return Ni(this.app,{lastSentHeartbeatDate:(s=e.lastSentHeartbeatDate)!==null&&s!==void 0?s:h.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){var s;if(await this._canUseIndexedDBPromise){const h=await this.read();return Ni(this.app,{lastSentHeartbeatDate:(s=e.lastSentHeartbeatDate)!==null&&s!==void 0?s:h.lastSentHeartbeatDate,heartbeats:[...h.heartbeats,...e.heartbeats]})}else return}}function ji(n){return Ee(JSON.stringify({version:2,heartbeats:n})).length}function ra(n){if(n.length===0)return-1;let e=0,s=n[0].date;for(let o=1;o<n.length;o++)n[o].date<s&&(s=n[o].date,e=o);return e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ya({appConfig:n,heartbeatServiceProvider:e},{fid:s}){const o=Ts(n),h=bs(n),u=e.getImmediate({optional:!0});if(u){const A=await u.getHeartbeatsHeader();A&&h.append("x-firebase-client",A)}const g={fid:s,authVersion:Es,appId:n.appId,sdkVersion:ws},w={method:"POST",headers:h,body:JSON.stringify(g)},I=await Ss(()=>fetch(o,w));if(I.ok){const A=await I.json();return{fid:A.fid||s,registrationStatus:2,refreshToken:A.refreshToken,authToken:As(A.authToken)}}else throw await _s("Create Installation",I)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hh=30,lh=1e3;class ch{constructor(e={},s=lh){this.throttleMetadata=e,this.intervalMillis=s}getThrottleMetadata(e){return this.throttleMetadata[e]}setThrottleMetadata(e,s){this.throttleMetadata[e]=s}deleteThrottleMetadata(e){delete this.throttleMetadata[e]}}const js=new ch;function uh(n){return new Headers({Accept:"application/json","x-goog-api-key":n})}async function fh(n){var e;const{appId:s,apiKey:o}=n,h={method:"GET",headers:uh(o)},u=Ya.replace("{app-id}",s),g=await fetch(u,h);if(g.status!==200&&g.status!==304){let w="";try{const I=await g.json();!((e=I.error)===null||e===void 0)&&e.message&&(w=I.error.message)}catch{}throw W.create("config-fetch-failed",{httpStatus:g.status,responseMessage:w})}return g.json()}async function dh(n,e=js,s){const{appId:o,apiKey:h,measurementId:u}=n.options;if(!o)throw W.create("no-app-id");if(!h){if(u)return{measurementId:u,appId:o};throw W.create("no-api-key")}const g=e.getThrottleMetadata(o)||{backoffCount:0,throttleEndTimeMillis:Date.now()},w=new mh;return setTimeout(async()=>{w.abort()},Ja),Bs({appId:o,apiKey:h,measurementId:u},g,w,e)}async function Bs(n,{throttleEndTimeMillis:e,backoffCount:s},o,h=js){var u;const{appId:g,measurementId:w}=n;try{await ph(o,e)}catch(I){if(w)return K.warn(`Timed out fetching this Firebase app's measurement ID from the server. Falling back to the measurement ID ${w} provided in the "measurementId" field in the local Firebase config. [${I==null?void 0:I.message}]`),{appId:g,measurementId:w};throw I}try{const I=await fh(n);return h.deleteThrottleMetadata(g),I}catch(I){const A=I;if(!gh(A)){if(h.deleteThrottleMetadata(g),w)return K.warn(`Failed to fetch this Firebase app's measurement ID from the server. Falling back to the measurement ID ${w} provided in the "measurementId" field in the local Firebase config. [${A==null?void 0:A.message}]`),{appId:g,measurementId:w};throw I}const R=Number((u=A==null?void 0:A.customData)===null||u===void 0?void 0:u.httpStatus)===503?Di(s,h.intervalMillis,hh):Di(s,h.intervalMillis),P={throttleEndTimeMillis:Date.now()+R,backoffCount:s+1};return h.setThrottleMetadata(g,P),K.debug(`Calling attemptFetch again in ${R} millis`),Bs(n,P,o,h)}}function ph(n,e){return new Promise((s,o)=>{const h=Math.max(e-Date.now(),0),u=setTimeout(s,h);n.addEventListener(()=>{clearTimeout(u),o(W.create("fetch-throttle",{throttleEndTimeMillis:e}))})})}function gh(n){if(!(n instanceof gt)||!n.customData)return!1;const e=Number(n.customData.httpStatus);return e===429||e===500||e===503||e===504}class mh{constructor(){this.listeners=[]}addEventListener(e){this.listeners.push(e)}abort(){this.listeners.forEach(e=>e())}}async function yh(n,e,s,o,h){if(h&&h.global){n("event",s,o);return}else{const u=await e,g=Object.assign(Object.assign({},o),{send_to:u});n("event",s,g)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function vh(){if(as())try{await hs()}catch(n){return K.warn(W.create("indexeddb-unavailable",{errorInfo:n==null?void 0:n.toString()}).message),!1}else return K.warn(W.create("indexeddb-unavailable",{errorInfo:"IndexedDB is not available in this environment."}).message),!1;return!0}async function wh(n,e,s,o,h,u,g){var w;const I=dh(n);I.then(L=>{s[L.measurementId]=L.appId,n.options.measurementId&&L.measurementId!==n.options.measurementId&&K.warn(`The measurement ID in the local Firebase config (${n.options.measurementId}) does not match the measurement ID fetched from the server (${L.measurementId}). To ensure analytics events are always sent to the correct Analytics property, update the measurement ID field in the local config or remove it from the local config.`)}).catch(L=>K.error(L)),e.push(I);const A=vh().then(L=>{if(L)return o.getId()}),[R,P]=await Promise.all([I,A]);ah(u)||eh(u,R.measurementId),h("js",new Date);const D=(w=g==null?void 0:g.config)!==null&&w!==void 0?w:{};return D[Xa]="firebase",D.update=!0,P!=null&&(D[Wa]=P),h("config",R.measurementId,D),R.measurementId}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
