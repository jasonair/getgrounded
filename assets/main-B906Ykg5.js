 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const X=new vn("@firebase/analytics");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hl=30,cl=1e3;class ul{constructor(e={},s=cl){this.throttleMetadata=e,this.intervalMillis=s}getThrottleMetadata(e){return this.throttleMetadata[e]}setThrottleMetadata(e,s){this.throttleMetadata[e]=s}deleteThrottleMetadata(e){delete this.throttleMetadata[e]}}const Bs=new ul;function fl(n){return new Headers({Accept:"application/json","x-goog-api-key":n})}async function dl(n){var e;const{appId:s,apiKey:o}=n,l={method:"GET",headers:fl(o)},f=Za.replace("{app-id}",s),g=await fetch(f,l);if(g.status!==200&&g.status!==304){let w="";try{const E=await g.json();!((e=E.error)===null||e===void 0)&&e.message&&(w=E.error.message)}catch{}throw Y.create("config-fetch-failed",{httpStatus:g.status,responseMessage:w})}return g.json()}async function pl(n,e=Bs,s){const{appId:o,apiKey:l,measurementId:f}=n.options;if(!o)throw Y.create("no-app-id");if(!l){if(f)return{measurementId:f,appId:o};throw Y.create("no-api-key")}const g=e.getThrottleMetadata(o)||{backoffCount:0,throttleEndTimeMillis:Date.now()},w=new yl;return setTimeout(async()=>{w.abort()},Ya),js({appId:o,apiKey:l,measurementId:f},g,w,e)}async function js(n,{throttleEndTimeMillis:e,backoffCount:s},o,l=Bs){var f;const{appId:g,measurementId:w}=n;try{await gl(o,e)}catch(E){if(w)return X.warn(`Timed out fetching this Firebase app's measurement ID from the server. Falling back to the measurement ID ${w} provided in the "measurementId" field in the local Firebase config. [${E==null?void 0:E.message}]`),{appId:g,measurementId:w};throw E}try{const E=await dl(n);return l.deleteThrottleMetadata(g),E}catch(E){const A=E;if(!ml(A)){if(l.deleteThrottleMetadata(g),w)return X.warn(`Failed to fetch this Firebase app's measurement ID from the server. Falling back to the measurement ID ${w} provided in the "measurementId" field in the local Firebase config. [${A==null?void 0:A.message}]`),{appId:g,measurementId:w};throw E}const k=Number((f=A==null?void 0:A.customData)===null||f===void 0?void 0:f.httpStatus)===503?Di(s,l.intervalMillis,hl):Di(s,l.intervalMillis),_={throttleEndTimeMillis:Date.now()+k,backoffCount:s+1};return l.setThrottleMetadata(g,_),X.debug(`Calling attemptFetch again in ${k} millis`),js(n,_,o,l)}}function gl(n,e){return new Promise((s,o)=>{const l=Math.max(e-Date.now(),0),f=setTimeout(s,l);n.addEventListener(()=>{clearTimeout(f),o(Y.create("fetch-throttle",{throttleEndTimeMillis:e}))})})}function ml(n){if(!(n instanceof yt)||!n.customData)return!1;const e=Number(n.customData.httpStatus);return e===429||e===500||e===503||e===504}class yl{constructor(){this.listeners=[]}addEventListener(e){this.listeners.push(e)}abort(){this.listeners.forEach(e=>e())}}async function vl(n,e,s,o,l){if(l&&l.global){n("event",s,o);return}else{const f=await e,g=Object.assign(Object.assign({},o),{send_to:f});n("event",s,g)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function wl(){if(as())try{await ls()}catch(n){return X.warn(Y.create("indexeddb-unavailable",{errorInfo:n==null?void 0:n.toString()}).message),!1}else return X.warn(Y.create("indexeddb-unavailable",{errorInfo:"IndexedDB is not available in this environment."}).message),!1;return!0}async function Il(n,e,s,o,l,f,g){var w;const E=pl(n);E.then(R=>{s[R.measurementId]=R.appId,n.options.measurementId&&R.measurementId!==n.options.measurementId&&X.warn(`The measurement ID in the local Firebase config (${n.options.measurementId}) does not match the measurement ID fetched from the server (${R.measurementId}). To ensure analytics events are always sent to the correct Analytics property, update the measurement ID field in the local config or remove it from the local config.`)}).catch(R=>X.error(R)),e.push(E);const A=wl().then(R=>{if(R)return o.getId()}),[k,_]=await Promise.all([E,A]);ll(f)||nl(f,k.measurementId),l("js",new Date);const b=(w=g==null?void 0:g.config)!==null&&w!==void 0?w:{};return b[Ja]="firebase",b.update=!0,_!=null&&(b[Xa]=_),l("config",k.measurementId,b),k.measurementId}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class El{constructor(e){this.app=e}_delete(){return delete Jt[this.app.options.appId],Promise.resolve()}}let Jt={},xi=[];const $i={};let an="dataLayer",Tl="gtag",Ui,Fs,Hi=!1;function Al(){const n=[];if(Vr()&&n.push("This is a browser extension environment."),zr()||n.push("Cookies are not available."),n.length>0){const e=n.map((o,l)=>`(${l+1}) ${o}`).join(" "),s=Y.create("invalid-analytics-context",{errorInfo:e});X.warn(s.message)}}function _l(n,e,s){Al();const o=n.options.appId;if(!o)throw Y.create("no-app-id");if(!n.options.apiKey)if(n.options.measurementId)X.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${n.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw Y.create("no-api-key");if(Jt[o]!=null)throw Y.create("already-exists",{id:o});if(!Hi){il(an);const{wrappedGtag:f,gtagCore:g}=al(Jt,xi,$i,an,Tl);Fs=f,Ui=g,Hi=!0}return Jt[o]=Il(n,xi,$i,e,Ui,an,s),new El(n)}function bl(n=ps()){n=hs(n);const e=ee(n,Ae);return e.isInitialized()?e.getImmediate():Sl(n)}function Sl(n,e={}){const s=ee(n,Ae);if(s.isInitialized()){const l=s.getImmediate();if(Qt(e,s.getOptions()))return l;throw Y.create("already-initialized")}return s.initialize({options:e})}function xs(n,e,s,o){n=hs(n),vl(Fs,Jt[n.app.options.appId],e,s,o).catch(l=>X.error(l))}const Vi="@firebase/analytics",zi="0.10.12";function Cl(){mt(new lt(Ae,(e,{options:s})=>{const o=e.getProvider("app").getImmediate(),l=e.getProvider("installations-internal").getImmediate();return _l(o,l,s)},"PUBLIC")),mt(new lt("analytics-internal",n,"PRIVATE")),nt(Vi,zi),nt(Vi,zi,"esm2017");function n(e){try{const s=e.getProvider(Ae).getImmediate();return{logEvent:(o,l,f)=>xs(s,o,l,f)}}catch(s){throw Y.create("interop-component-reg-failed",{reason:s})}}}Cl();var Gi=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
...
`)};function qt(t){t.onreadystatechange&&t.onreadystatechange.call(t)}Object.defineProperty(de.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(t){this.m=t?"include":"same-origin"}});function oi(t){let i="";return J(t,function(r,a){i+=a,i+=":",i+=r,i+=`\r
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const K={CANCELLED:"cancelled",INVALID_ARGUMENT:"invalid-argument",FAILED_PRECONDITION:"failed-precondition"};class W extends yt{constructor(e,s){super(e,s),this.code=e,this.message=s,this.toString=()=>`${this.name}: [code=${this.code}]: ${this.message}`}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
